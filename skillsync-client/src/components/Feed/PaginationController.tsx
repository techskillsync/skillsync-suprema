...
function PaginationController(handlePageChange: (page: number) => void, currentPage: number, totalPages: number) {
    return <div className='pagination !mx-auto !text-white'>
        <button

  ...
  return (
    <div className="p-[1.5px] bg-gradient-to-r from-green-400 via-blue-500 to-purple-600 rounded-lg">
      <div className="relative">
        <div className="w-full h-full bg-[#1e1e27] rounded-md flex flex-col lg:flex-row space-x-3 text-lg p-5">
          <div className="flex flex-col justify-center rounded-full overflow-hidden">
            <ProfilePicture/>
          </div>
          <div className="flex flex-col justify-center text-left w-full lg:pl-2 pb-4">
